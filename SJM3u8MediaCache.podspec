...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SJM3u8MediaCache.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/erik/SJM3u8MediaCache'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'erik' => 'wo160.160@163.com' }
  s.source           = { :git => 'https://github.com/erik/SJM3u8MediaCache.git', :tag => s.version.to_s }
